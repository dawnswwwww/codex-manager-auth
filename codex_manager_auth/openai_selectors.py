...
CSS_OA_BIRTHDAY_HIDDEN_INPUT = 'input[name="birthday"][type="hidden"]'
...
CSS_L_PASSWORDLESS_LOGIN_BTN = 'button[name="intent"][value="passwordless_login_send_otp"]'
...
CSS_INVALID_PASSWORD_ERROR = 'text=/Incorrect email address or password/i'
